...
export default function ContentSection({
  ...
  return (
    <>
      <div className="lg:px-28 bg-custom-gradient bg-cover bg-center h-auto">
        <div className="flex justify-between items-center h-full text-black md:pt-32">
          <div className="my-16 flex gap-7 justify-center px-12 md:px-52 flex-col items-center w-full">
      ...
      <div className="w-full h-auto p-20 px-12 md:px-28  flex flex-col gap-12 md:gap-7 mb-6 items-center">
